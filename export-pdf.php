<?php require_once("controller/script.php");
  ...
  $_SESSION['page-name']="Export PDF"; $_SESSION['page-to']="export-pdf"; $_SESSION['search']=2;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <a href="export-pdf-baru?prodi=Arsitektur" class="btn btn-success btn-sm" target="_blank">Export</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <a href="export-pdf-baru?prodi=Teknik-Sipil" class="btn btn-success btn-sm" target="_blank">Export</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <a href="export-pdf-baru?prodi=Ilmu-Komputer" class="btn btn-success btn-sm" target="_blank">Export</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <a href="export-pdf-wisuda?prodi=Arsitektur" class="btn btn-success btn-sm" target="_blank">Export</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <a href="export-pdf-wisuda?prodi=Teknik-Sipil" class="btn btn-success btn-sm" target="_blank">Export</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <a href="export-pdf-wisuda?prodi=Ilmu-Komputer" class="btn btn-success btn-sm" target="_blank">Export</a>
                  </div>
                </div>
              </div>
            </div>
